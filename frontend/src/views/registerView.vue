		...
		<div class="main-agileinfo">
			<div class="agileits-top">
				<form action="#" method="post">
					<input v-model="userName" class="text" type="text" name="Username" placeholder="Username" required="">
					...
					<div class="errorMsg">{{erreurMdp}}</div>
					<input @click="enregistrer" id="modifButton" type="button" value="S'inscrire">
				</form>
				<p>Vous avez deja un compte ? <a href="#"> Connecte-toi !</a></p>
			</div>
		</div>
	</div>
</template>
    ...
    export default {
        data() {
            return {
				...
				confirmPassword: "",
				erreurMdp: "",
                getApiUserRegister: "http://localhost:3000/users/register"
            }
        },
        methods: {
            enregistrer() {
				...
				const objetRegister = {userName, email, mdp};
				if(mdp == confirmMdp) {
					fetch(this.getApiUserRegister, {
						method: "POST",
						headers: {
...
sup, tt, var, b, u, i, dl, dt, dd,
ol, nav ul, nav li, fieldset, form,
