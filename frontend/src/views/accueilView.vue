<template>
    <div id="button-global">
        <button class="classButton">Mon compte</button>
        <button @click="deconnecter" class="classButton">Déconnexion</button>
    </div>
   <div v-for="post of postsArray" :key="post" class="container mt-5 mb-5">
                ...
                <div class="card">
                    <div class="d-flex justify-content-between p-2 px-3">
                        <div class="d-flex flex-row align-items-center"> <img src="https://i.imgur.com/UXdKE3o.jpg" width="50" class="rounded-circle">
                            <div class="d-flex flex-column ml-2"> <span class="font-weight-bold">{{post.pseudo}}</span> <small class="text-primary">Collegues</small> </div>
                        </div>
                        <div class="d-flex flex-row mt-1 ellipsis"> <small class="mr-2">20 mins</small> <i class="fa fa-ellipsis-h"></i> </div>
                    </div> 
                    <img :src="dd" class="img-fluid">
                    <div class="p-2">
